...
<template>
  ...
  <!------Header-------->
  <v-app-bar app elevation="0" height="70" class="top-header bg-white px-4">
    <div class="d-flex align-center justify-space-between w-100">
      <!-- KIRI: Sidebar Toggle + Breadcrumb -->
      <div class="d-flex align-center">
        <!-- Sidebar Toggle -->
        <v-btn class="text-muted sidebar-toggle-btn me-2" @click="toggleSidebar" icon variant="flat" size="small">
          <MenuIcon size="20" stroke-width="1.5" />
        </v-btn>

        <!-- Mobile Toggle -->
        <v-btn class="hidden-lg-and-up text-muted me-3" @click="sDrawer = !sDrawer" icon variant="flat" size="small">
