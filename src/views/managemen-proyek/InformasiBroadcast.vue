<template>
  ...
  <div class="h-full w-[50%] bg-[#fff] px-6 py-8 rounded-lg shadow-md mb-6">
    ...
    <a-form layout="vertical" @submit.prevent="handleSubmit" class="space-y-4">
      ...
      <!-- Target Peserta -->
      <a-form-item label="Target Peserta" name="target" class="mb-6 w-full">
        <a-select
      ...
      <a-form-item>
        <a-button
          type="primary"
          html-type="submit"
          class="bg-[#003366] hover:bg-[#002855] text-white font-medium rounded-md w-full md:w-auto"
        >
  ...
  <div class="h-full bg-[#f6f8fb] p-8">
     <div class="bg-[white] rounded-lg shadow-sm border border-gray-100 px-6 py-6">
        <div class="flex justify-between items-center mb-4">
        <div>
          <h2 class="text-[24px] font-semibold text-[#03386B]">Riwayat Broadcast</h2>
          <p class="text-sm text-[#55565A]">Broadcast yang baru baru ini dikirim dan terjadwal</p>
        </div>
      </div>
